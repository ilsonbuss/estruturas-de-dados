...
public:
    ...
    //Cria um novo ramo
    AVLBranch(T data, AVLBranch<T>* parent = null) {
        this->data = data;
        left = null;
        right = null;
        this->parent = parent;
    ...
    void insertLeft(T data) {
        //Cria novo
        AVLBranch<T>* newAVLBranch = new AVLBranch<T>(data, this);
    ...
    AVLBranch<T>* removeMe() {
        ...
        AVLBranch<T>* b = right;
        AVLBranch<T>* bparent = null;
        while(b != null) {
            bparent = b;
            b = b->left;
        }
        AVLBranch<T>* descendent = bparent;//Este ramo vai ficar no lugar do que será removido
